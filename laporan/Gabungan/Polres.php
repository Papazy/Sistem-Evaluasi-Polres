        ...
        <div class="px-4">
            <div class="d-flex align-items-end mb-2">
                ...
                <div class="col-auto me-3">
                    <a href="<?php echo $main_url?>laporan/Gabungan/Polda.php" class="btn btn-secondary">
                        Data Polda
                                        ...
                                        foreach ($dataPolres as $polres => $pg) {
                                            ...
                                            foreach ($PG_ALL as $program) { // Sesuaikan dengan PG yang Anda perlukan
                                               ...
                                               if ($pg[$program] == -1) {
                                                    ...
                                                    echo "<td class='bg-success'>{$persen}</td>"; // Jika persen lebih besar atau sama dengan Max, gunakan bg-successfull
                                                } elseif ($persen > $Min) {
                                                    echo "<td class='bg-warning'>{$persen}</td>"; // Jika persen di antara Min dan Max, gunakan bg-warning
                                                } else {
                                                    echo "<td class='bg-danger'>{$persen}</td>"; // Jika persen kurang dari atau sama dengan Min, gunakan bg-danger
                                                }
                                            }
                                            $total = $total / $count;
                                            if ($total == -1) {
                                                ...
                                                echo "<td class='bg-success'>{$total}</td>"; // Jika total lebih besar atau sama dengan Max, gunakan bg-successfull
                                            } elseif ($total > $Min) {
                                                echo "<td class='bg-warning'>{$total}</td>"; // Jika total di antara Min dan Max, gunakan bg-warning
                                            } else {
                                                echo "<td class='bg-danger'>{$total}</td>"; // Jika total kurang dari atau sama dengan Min, gunakan bg-danger
                                            }
