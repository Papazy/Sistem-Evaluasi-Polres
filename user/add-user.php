                    ...
                    <form action="proses-user.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <span class="h5 my-2"><i class="fa-solid fa-user-plus"></i> Tambah</span>
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <label for="" class="col-sm-1 col-form-label">:</label>
                                                <div class="col-sm-9" style="margin-left: -45px;">
                                                    <textarea name="alamat" id="alamat" cols="30" rows="3" class="form-control" placeholder="isi" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4 text-center px-5">
                                            <img src="../asset/image/profil.png" alt="gambar user" class="mb-3" width="40%">
