        ...
        <div class="container-fluid px-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?= $main_url ?>polres/add-polres.php" class="btn btn-sm btn-primary float-end"><i
                    ...
                    <table class="table table-hover" id="example">
                        <thead>
                            <tr>
                                <th scope="col">No.</th>
                                <th scope="col">
                                    <center>Nama Polres</center>
                                </th>
                                <th scope="col">
                                    <center>Lokasi/koordinat</center>
                                </th>
                                <th scope="col">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="" class="btn btn-sm btn-warning"><i class="fa-solid fa-pen"
                                            title="Edit"></i> Edit</a>
